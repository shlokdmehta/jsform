$(document).ready(function(){
	$("#sname").keyup(function(){
		$.post("process.php",{"sname": $("sname").val()},
			function(data){
				...
				}else if(data == "Student name can not contain digits"){
	...
	$("#sid").keyup(function(){
		$.post("process.php",{"sid": $("#sid").val()},
			function(data2){
				if (data2 == "Student ID must contain only digits"){
